...
#         """
#         Args:
#             model_id: Local model ID or Hugging Face endpoint
#             use_hf_api: Whether to use Hugging Face API instead of local model
#         """
...
#         else:
#             self._init_local_model(model_id)
...
#                       prompt: str, 
#                       steps: int = 20) -> Generator[Tuple[int, Image.Image], None, None]:
#         """
#         Generate images with progress streaming
#         Falls back to Hugging Face API if local generation fails
#         """
#         if self.use_hf_api:
...
#                 print(f"Local generation failed, falling back to API: {local_error}")
#                 self.use_hf_api = True
#                 yield from self._generate_via_api(prompt)

#     def _generate_local(self, 
#                       prompt: str, 
#                       steps: int) -> Generator[Tuple[int, Image.Image], None, None]:
...
#         try:
#             # First yield a progress indicator
#             yield 10, Image.new("RGB", (512, 512), color="gray")
